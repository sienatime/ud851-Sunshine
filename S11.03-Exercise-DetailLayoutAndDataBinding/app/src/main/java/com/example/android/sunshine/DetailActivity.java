...
public class DetailActivity extends AppCompatActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        detailBinding.primaryInfo.date.setText(dateText);
        ...
        detailBinding.primaryInfo.weatherIcon.setImageResource(weatherImage);
        ...
        detailBinding.extraInfo.humidity.setText(humidityString);
        detailBinding.extraInfo.humidity.setContentDescription(humidityA11y);
        detailBinding.extraInfo.humidityLabel.setContentDescription(humidityA11y);
        ...
        detailBinding.extraInfo.wind.setText(windString);
        detailBinding.extraInfo.wind.setContentDescription(windA11y);
        detailBinding.extraInfo.windLabel.setContentDescription(windA11y);
        ...
        detailBinding.extraInfo.pressure.setText(pressureString);
        detailBinding.extraInfo.pressure.setContentDescription(pressureA11y);
        detailBinding.extraInfo.pressureLabel.setContentDescription(pressureA11y);
