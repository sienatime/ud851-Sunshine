...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        forecastAdapterViewHolder.tempHigh.setText(SunshineWeatherUtils.formatTemperature(mContext, highInCelsius));
        forecastAdapterViewHolder.tempLow.setText(SunshineWeatherUtils.formatTemperature(mContext, lowInCelsius));
    ...
    class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ForecastAdapterViewHolder(View view) {
            ...
            weatherDescription = (TextView) view.findViewById(R.id.textViewWeather);
            tempHigh = (TextView) view.findViewById(R.id.textViewHigh);
            tempLow = (TextView) view.findViewById(R.id.textViewLow);
